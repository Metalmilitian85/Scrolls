...
export default function Home() {
    return (
        <div>
            ...
            <h3 className="mx-8 mt-8 mb-12 text-2xl text-white text-center">This page has all the information you'll need on The Elder Scrolls history for the main games and books.</h3>
            <div className="videoWrapper md:w-full">
