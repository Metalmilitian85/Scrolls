...
export default function Morrowind() {
    return (
        <div id="Morrowind" className="mb-5 pt-24">
            ...
            <h3 className="text-3xl text-center text-white mt-3">Morrowind</h3>
              <div className="text-white m-8">
                ...
                <p>The game has over 300 books (not counting spell scrolls). One particular compilation of the text was 1,241 sheets of 8.25 × 11 inch paper. 
