    ...
    <nav className="top-0 flex justify-between items-center h-24 max-w-100vh mx-auto px-4 text-blue font-bold bg-gradient-to-r from-black to-gray-700">
        <div onClick={handleNav} className="block md:hidden" >
          ...
          <ul className="hidden md:flex text-purple-100 p-8 text-lg items-center">
            <a href='#/'><li className="p-4 hover:text-purple-200 hover:scale-105 duration-300">Home</li></a>
            <Dropdown3 />
            <Dropdown4 />
            <a href='#/History'><li className="p-4 hover:text-purple-200 hover:scale-105 duration-300">History</li></a>
      ...
      <div className="content-between">  
        ...
        <div className={!nav ? "fixed left-0 top-0 w-[40%] h-full bg-gradient-to-r from-black to-gray-700 border-r border-r-gray-900 bg-purple-100 ease-in-out duration-200" : "fixed left-[-100%]"}>
          <ul className="p-4 text-white">
            ...
            <a href='#/History'><li onClick={handleNav} className="p-4 border-b border-gray-600">History</li></a>
